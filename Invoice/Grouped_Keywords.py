...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun  3 19:48:03 2018
...
#keys=[['BILL','TO:'],['SHIPPING','TO:'],['Invoice','Date'],['Name','of','Rep.'],['Contact','Phone'],['Payment','Terms']]
keys=[['PRODUCTS','/','SERVICE'],['QUANTITY','/','HOURS']]
...
if __name__ == '__main__':
    app.run()
>>>>>>> b7a708c6171cdec1745cf7027a8d79809429b27e
